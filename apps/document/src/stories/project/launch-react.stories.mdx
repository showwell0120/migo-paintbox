...
```bash
"scripts": {
    "deploy.dev": "git stash; pnpm build && cd ansible; ansible-playbook -i hosts evergreen-frontend.yml --limit dev",
    "deploy.stage": "git stash; pnpm build && cd ansible; ansible-playbook -i hosts evergreen-frontend.yml --limit staging",
    "deploy.prod": "git stash; pnpm build && cd ansible; ansible-playbook -i hosts evergreen-frontend.yml --limit production"
},
```
